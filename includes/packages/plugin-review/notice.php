...
?>
		...
		<div id="duckdev-reviews-<?php echo esc_attr($this->slug); ?>" class="<?php echo esc_attr($this->get_classes()); ?>">
			<p>
			...
			<div style="display: flex;justify-content: flex-end;margin-bottom: 10px;">
				...
				<?php if (!empty($this->action_labels['review'])) : ?>
					<p>
						<a class="button button-primary" href="https://wordpress.org/support/plugin/<?php echo esc_html($this->slug); ?>/reviews/#new-post" target="_blank">
				...
				<?php if (!empty($this->action_labels['later'])) : ?>
					<p>
						<a class="button" href="<?php echo esc_url(add_query_arg($this->key('action'), 'later')); ?>">
				...
				<?php if (!empty($this->action_labels['dismiss'])) : ?>
					<p>
						<a class="button success" href="<?php echo esc_url(add_query_arg($this->key('action'), 'dismiss')); ?>">
